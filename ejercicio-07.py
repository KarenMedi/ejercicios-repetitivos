...
print(f'{amarillo} tienen etiqueta amarilla')
print(f'{rosa} tienen etiqueta rosa')
print(f'{roja} tienen etiqueta roja')
print(f'{verde} tienen etiqueta verde')
print(f'{azul} tienen etiqueta azul')